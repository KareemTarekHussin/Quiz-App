...
import { useAllQuestionsQuery } from '../../../redux/Questions/questionSlice';
      ...
      <div className="p-3 mt-2 overflow-x-auto border-2 rounded-md" >
        {isLoading ? <div className='flex items-center justify-between font-semibold'>
          ...
          : <div className='flex items-center justify-between font-semibold'>
            <Button  type="button" onClick={openModal} variant={'outline'} rounded={'full'} className="gap-2 text-left group "><Plus className='p-1 text-white transition bg-black rounded-full group-hover:bg-white group-hover:text-black duration-0' size={19} strokeWidth={5} /> <span></span> </Button>
          </div>}
